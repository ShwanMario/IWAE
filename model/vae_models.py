...
class IWAE_1(nn.Module):
    ...
    def encoder(self, x):
        ...
        eps = Variable(sigma_h1.data.new(sigma_h1.size()).normal_())  #create a tensor subjected to Gaussian distribution with the same datatype as sigma_h1
...
class IWAE_2(nn.Module):
    def __init__(self, dim_h1, dim_h2, dim_image_vars,hidden_layer_1=200,hidden_layer_2=100,p_x='discrete'):
        ...
        ## encoder
        self.encoder_h1 = BasicBlock(dim_image_vars, hidden_layer_1, dim_h1)
